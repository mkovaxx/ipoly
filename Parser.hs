...
happyReduction_1 (HappyTerminal (Constant happy_var_1))
	 =  HappyAbsSyn4
		 (Con happy_var_1
	)
...
happyReduction_2 (HappyTerminal (Variable happy_var_1))
	 =  HappyAbsSyn4
		 (Var happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Constant happy_dollar_dollar -> cont 5;
	Variable happy_dollar_dollar -> cont 6;
	Whatever '+' -> cont 7;
	Whatever '-' -> cont 8;
	Whatever '*' -> cont 9;
	Whatever '/' -> cont 10;
